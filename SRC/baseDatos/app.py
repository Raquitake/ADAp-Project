...
from models import db, Usuario, Administrador, Evento, Entrada  # Ajusta según tus modelos
...
def eventos():
    ...
    rifas = [
        {"id": 1, "titulo": "Rifa Cesta Solidaria", "premio": "Cesta con productos locales y artesanales.",
         "fecha_sorteo": "20/12/2025", "descripcion": "Incluye productos típicos del municipio.",
...
def get_rifas():
    return {
        1: {"id": 1, "titulo": "Rifa Cesta Solidaria", "premio": "Cesta con productos locales y artesanales.",
            "fecha_sorteo": "20/12/2025", "descripcion": "Incluye productos típicos del municipio.",
            "imagen": "img/rifa-cesta.jpg"}
    }
...
def hazte_voluntario():
    if request.method == 'POST':
        flash('Gracias por tu solicitud de voluntario. Te contactaremos pronto.')
        return redirect(url_for('index'))
